...
const CUSTOMERS = gql`
  query GetCustomers(
    ...
    customers(pagination: $pagination, filters: $filters, sort: $sort) {
      data {
        id
        attributes {
          customerImageUrl
      ...
      <aside className='hidden xl:order-first xl:flex xl:flex-col flex-shrink-0 w-96 border-r border-gray-200'>
        ...
        <div className='px-6 pt-6 pb-4'>
          ...
          <p className='mt-1 text-sm text-gray-600'>
            Search directory of {data?.customers.data.length} customer
            {data?.customers.data.length !== 1 && 's'}
          </p>
          <form
                    ...
                    <li key={customer.id}>
                      <div className='relative group py-4 px-6 flex items-center'>
                        ...
                        >
                          ...
                          />
                          <div className='flex-1 flex items-center min-w-0 relative'>
                            <span className='bg-gray-100 border rounded-lg flex-shrink-0 inline-block relative'>
                              {/* <DocumentTextIcon
                          className='text-gray-500 flex-shrink-0 h-8 w-8'
                          aria-hidden='true'
                        /> */}
                              {customer.attributes.customerImageUrl ? (
                                <img
                                  className='h-12 w-12 rounded-lg'
                                  src={customer.attributes.customerImageUrl}
                                  alt=''
                                />
                              ) : (
                                <OfficeBuildingIcon
                        ...
                        /> */}
                            ...
                            <div className='ml-4 truncate'>
                              ...
                              <p className='text-sm text-gray-500 truncate'>
                                {customer.attributes.customerLocation}
                              </p>
                            </div>
                          </div>
                        </Link>
